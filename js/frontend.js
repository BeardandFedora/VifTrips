...
/**
 * Init Trips List navigation
 */
function gpInitTripsList() {

    var tripsListMore = jQuery( '.trips-list-more' );

    if ( tripsListMore.length > 0 ) {

        tripsListMore.on( 'click', 'a', function(e){
            e.preventDefault();
            var curLink = jQuery( this );
            var divElt = curLink.parents( '#trips-list' );
 ...
 */
function gpInitMaps() {
    var gpMaps = jQuery( '.vif-leaflet-map' );
